...
# Revised by Shaohua Li in Apr 2017. 
# Please refer to https://github.com/anishathalye/neural-style for a user manual
...
def build_parser():
    ...
    parser.add_argument('--lap-layers', type=str,
            dest='lap_layers', help='Laplacian layers (default %(default)s)',
            metavar='LAP_LAYERS', default=LAP_LAYERS)
    parser.add_argument('--lap-weight', type=float,
            dest='lap_weight', help='laplacian weight (default %(default)s)',
            metavar='LAP_WEIGHT', default=LAP_WEIGHT)
...
def main():
    ...
    options.lap_layers = options.lap_layers.split(',')
    ...
    for iteration, image in stylize(
        ...
        lap_layers=options.lap_layers,
        lap_weight=options.lap_weight,
